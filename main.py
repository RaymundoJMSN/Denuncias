...
EMERGENCIAS = [
    {
        ...
        "telefone": "190",
        "icone": ft.Icons.LOCAL_POLICE,
        "descricao": "Emergência policial imediata.",
        "cor": ft.Colors.RED_700,
    },
    {
        "titulo": "SAMU",
        "telefone": "192",
        "icone": ft.Icons.MEDICAL_SERVICES,
        "descricao": "Emergência médica e atendimento pré-hospitalar.",
        "cor": ft.Colors.RED_600,
    },
    {
        "titulo": "Bombeiros",
        "telefone": "193",
        "icone": ft.Icons.FIRE_TRUCK,
        "descricao": "Incêndios, resgates e situações de risco.",
    ...
    },
    {
        ...
        "descricao": "Emergências em rodovias federais.",
        "cor": ft.Colors.BLUE_800,
    },
    {
        "titulo": "Polícia Civil",
        "telefone": "197",
        "icone": ft.Icons.BADGE,
        "descricao": "Ocorrências, investigações e atendimento policial civil.",
    ...
    },
    {
        ...
        "descricao": "Desastres, enchentes, deslizamentos e riscos estruturais.",
        "cor": ft.Colors.AMBER_800,
    },
    {
        "titulo": "Guarda Municipal",
        "telefone": "153",
        "icone": ft.Icons.SECURITY,
        "descricao": "Atendimento da Guarda Municipal, quando disponível na cidade.",
        "cor": ft.Colors.GREEN_800,
    },
    {
        "titulo": "Central de Atendimento à Mulher",
        "telefone": "180",
        "icone": ft.Icons.WOMAN,
        "descricao": "Orientação e denúncias de violência contra a mulher.",
        "cor": ft.Colors.PINK_700,
    },
    {
        "titulo": "Disque Direitos Humanos",
        "telefone": "100",
        "icone": ft.Icons.REPORT,
    ...
    },
    {
        ...
        "telefone": "181",
        "icone": ft.Icons.REPORT_PROBLEM,
        "descricao": "Denúncia anônima, quando disponível no estado.",
        "cor": ft.Colors.BLUE_GREY_700,
    },
    {
        "titulo": "CVV",
        "telefone": "188",
        "icone": ft.Icons.SUPPORT_AGENT,
        "descricao": "Apoio emocional gratuito e sigiloso.",
...
def main(page: ft.Page):
    ...
    async def abrir_discador(telefone: str):
        await url_launcher.launch_url(f"tel:{telefone}")

    async def abrir_site(url: str):
    ...
    def criar_topo():
        return ft.Semantics(
            label="Denúncia Já. Emergência e denúncia em um só lugar.",
            header=True,
    ...
    def criar_aviso_compacto():
        return ft.Container(
            ...
            content=ft.Row(
                ...
                vertical_alignment=ft.CrossAxisAlignment.CENTER,
                controls=[
                    ft.Icon(ft.Icons.INFO_OUTLINE, size=22,
                            color=ft.Colors.RED_700),
    ...
    def criar_card_ligacao(item):
        ...
        return ft.Semantics(
            ...
            content=ft.Container(
                ...
                content=ft.Card(
                    elevation=1, bgcolor=ft.Colors.WHITE,
                    content=ft.Container(
                    ...
                    content=ft.Container(
                        ...
                        content=ft.Column(
                            ...
                            controls=[
                                ...
                                ft.Button(
                                    content="Abrir denúncia online",
                                    icon=ft.Icons.OPEN_IN_BROWSER,
                                    on_click=ao_clicar_site,
                                    height=48,
                                    tooltip=f"Abrir {titulo} no navegador",
                                    style=ft.ButtonStyle(
                                        bgcolor=cor, color=ft.Colors.WHITE,
                                        shape=ft.RoundedRectangleBorder(radius=12),
                                    ),
                                ),
                            ],
